...
class FamilyDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    available_multiple_appointments_per_week: Field::Boolean,
    ...
    family_interest: Field::Select.with_options(searchable: false, collection: ->(field) {
  ...
  SHOW_PAGE_ATTRIBUTES = [:id, :address_1, :address_2, :available_counselor_transportation,
                          :available_multiple_appointments_per_week, :available_school_transportation,
                          :available_visit_transportation, :cats, :city, :dogs, :email, :experience_with_care,
                          :family_interest, :icwa, :last_contacted_at, :latitude, :license_date, :longitude, :name,
                          :organization, :other_animals, :other_children_in_home, :phone, :race,
  ...
  FORM_ATTRIBUTES = [:address_1, :address_2, :available_counselor_transportation,
                     :available_multiple_appointments_per_week, :available_school_transportation,
                     :available_visit_transportation, :cats, :city, :dogs, :email, :experience_with_care,
                     :family_interest, :icwa, :last_contacted_at, :latitude, :license_date, :longitude, :name,
                     :organization, :other_animals, :other_children_in_home, :phone, :race, :recreational_activities,
                     :region, :religion, :results, :searches, :skills, :spots_available, :state, :status, :zip,].freeze
