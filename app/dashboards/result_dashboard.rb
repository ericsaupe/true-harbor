...
class ResultDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = [:id, :family, :score, :search].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = [:id, :family, :score, :search, :selected, :created_at, :updated_at].freeze

  # FORM_ATTRIBUTES
  # an array of attributes that will be displayed
  # on the model's form (`new` and `edit`) pages.
  FORM_ATTRIBUTES = [:family, :score, :search, :selected].freeze
