...
class FamiliesController < AuthenticatedController
  ...
  def family_params
    allowed_params = params.require(:family).permit(:name, :address_1, :address_2, :city, :state, :zip, :email,
      :region_id, :license_date, :status, :race, :religion, :family_interest, :other_children_in_home, :spots_available,
      ...
      phone: [], experience_with_care: {}, recreational_activities: {}, skills: {},
